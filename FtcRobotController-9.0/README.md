...
$\hspace{15mm}$ [FTC Blocks Online Tutorial](https://ftc-docs.firstinspires.org/programming_resources/blocks/Blocks-Tutorial.html)
...
$\hspace{2cm}$ `git clone https://github.com/FIRST-Tech-Challenge/FtcRobotController.git`
* To reduce cloning time, you can add the `--depth 1` flag.
...
$\hspace{15mm}$ [FIRST Tech Challenge Documentation](https://ftc-docs.firstinspires.org/index.html)
...
$\hspace{15mm}$ [FTC Javadoc Documentation](https://javadoc.io/doc/org.firstinspires.ftc)

### Online User Forum
For technical questions regarding the Control System or the FTC SDK, please visit the FIRST Tech Challenge Community site:

$\hspace{15mm}$ [FIRST Tech Challenge Community](https://ftc-community.firstinspires.org/)
